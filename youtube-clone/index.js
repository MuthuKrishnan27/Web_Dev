...
const apiKey = "AIzaSyBd1k1vrv2h7x6c3C7G8aIs3slskjsC3Vg";
localStorage.setItem("api_key", apiKey);
const container = document.getElementById("container");

/*
    https://youtube.googleapis.com/youtube/v3/search?part=snippet,statistics&maxResults=1&q=mycodeschool&key=AIzaSyD72A86QUtCU1UNFW2zpbzCVO6ImKzbRic
*/
...
function navigateToVideo(videoItem){
 ...
 // video_id: video_id
    ...
    document.cookie = `channel_id=${channelId} ; path=${path}`;
