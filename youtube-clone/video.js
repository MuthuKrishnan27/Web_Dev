...
let videoArr = arr[0].split("=");
let vArr = videoArr[1].split(";");
let videoId = vArr[0];
// console.log(videoId);
let channelArr = arr[1].split("=");
let channelId = channelArr[1];
// console.log(channelId);

const apiKey = localStorage.getItem("api_key")

let channelLogoUrl, subscriberCount, channel;
channelInfo();
...
async function  fetchStats(videoId){
    ...
    try {
        ...
        <div class="profile">
                <img src=${channelLogoUrl} class="channel-logo" alt="logo">
